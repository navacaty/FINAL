...
for department in { d[9] for d in s_emp[1::] }: print (lambda deptId, Sal: (deptId, Sal))(department, (lambda x: x * 12 ))(map(float,[ int(e[7]) for e in s_emp[1::] if e[9] == department ]))
